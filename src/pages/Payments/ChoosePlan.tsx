// src/pages/Payments/ChoosePlan.tsx (Final Version)
          ...
          {subscriptions.map((sub) => (
            <div key={sub.id} className="border p-6 rounded-lg shadow-lg flex flex-col">
              ...
              <ul className="mb-6 space-y-2">
                {sub.features.map((feature, index) => <li key={index} className="flex items-start"><span className="text-green-500 mr-2 mt-1">✓</span>{feature}</li>)}
              </ul>
              <button 
